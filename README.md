...
<td><b>Парк техники.</b> Маникюрные ножницы построены процедурно из 2D-профиля, щёлкают, а скорость подхватывают от скорости прокрутки страницы.</td>
</tr>
</table>
...
<tr>
<td><b>До / после.</b> Оба состояния газона нарисованы SVG-ом, шторка тянется мышью, клавишами и пальцем.</td>
...
| UI       | React 19                                                         |
| 3D       | three.js 0.180 через `@react-three/fiber` 9, собственные шейдеры |
| Анимация | GSAP + ScrollTrigger, Lenis, CSS-переходы                        |
...
3D написано на голом three.js. Вся вёрстка — обычный CSS с переменными,
без препроцессоров и рантайм-стилей.

Итоговый вес: **~400 КБ gzip**, из них 181 КБ — сам three.js.
...
`photo` в массиве `TEAM`. Кадр 3:4. Промпт для генерации — в
[`docs/gemini-prompt.md`](docs/gemini-prompt.md).
