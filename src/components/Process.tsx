      ...
      <div className="process__viewport">
        ...
        <div className="process__track" ref={track}>
          ...
          <article className="step step--end">
            ...
            <p className="step__d">
              Именно повторяемость превращает участок в газон. Один раз покосить может кто угодно — вопрос в том, кто
              приедет на восемнадцатый раз в конце августа, когда уже никому не интересно.
            </p>
